...
const UserProfile = () => {
    ...
    useEffect(()=>{
        fetch(MYCONSTCLASS.APIURL+`/user/${userid}`,{
            headers:{
    ...
    const followUser = () => {
        fetch(MYCONSTCLASS.APIURL+'/follow',{
            method:"PUT",
            headers:{
     ...
     const unfollowUser = () => {
        fetch(MYCONSTCLASS.APIURL+'/unfollow',{
            method:"PUT",
            headers:{
                "Content-Type": "application/json",
                "Authorization":"Bearer " +localStorage.getItem("jwt")
    ...
    <>
        {
            ...
            <div style={{
                ...
                <div>
                    <img style={{width:"160px",height:"160px",borderRadius:"80px"}} alt="" src={profile.user.pic}/>
                </div>
                <div>
